...
class _CameraState extends State<Camera> {
  ...
  void _upload(File file) async {
    ...
    dio
        .post(
            "https://conuhackstestvision-prediction.cognitiveservices.azure.com/customvision/v3.0/Prediction/f4ba3506-b2a3-4398-a13f-b187e13a0fc7/classify/iterations/Iteration4/image",
            data: data)
        .then((response) {
